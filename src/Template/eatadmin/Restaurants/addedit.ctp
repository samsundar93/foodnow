                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                            ...
                                                            <span class="input-group-addon btn btn-default btn-file">
                                                               ...
                                                               <input type="file" name="restaurantlogo">
                                                            </span>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="monday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['monday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="monday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['monday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="monday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['monday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="monday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['monday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="tuesday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['tuesday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="tuesday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['tuesday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="tuesday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['tuesday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="tuesday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['tuesday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="wednesday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['wednesday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="wednesday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['wednesday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="wednesday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['wednesday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="wednesday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['wednesday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="thursday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['thursday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="thursday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['thursday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="thursday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['thursday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="thursday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['thursday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="friday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['friday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="friday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['friday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="friday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['friday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="friday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['friday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="saturday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['saturday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="saturday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['saturday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="saturday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['saturday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="saturday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['saturday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="sunday_firstopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['sunday_firstopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="sunday_firstclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['sunday_firstclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-sm-offset-1">
                                                                    <div class="col-sm-5">
                                                                        <select name="sunday_secondopen_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['sunday_secondopen_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <select name="sunday_secondclose_time" class="form-control">
                                                                            <?php foreach($timingAm as $key => $value) { ?>
                                                                                <option <?php echo ($restaurantList['sunday_secondclose_time'] == $value) ? 'selected' : ''; ?> value="<?php echo $value; ?>" >
                                                                                    <?php echo $value ?>
                                                                                </option>
                                                                            <?php } ?>
