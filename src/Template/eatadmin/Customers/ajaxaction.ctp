            ...
            foreach ($custList as $key=>$list):?>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-icon-toggle" data-original-title="Delete" data-placement="top" data-toggle="tooltip" type="button" id="<?php echo $list['id']; ?>" onclick="return deleteRecord(<?php echo $list['id']; ?>, 'customers/deletecust', 'customer', 'ajaxReplace')">
